...
//     return py::make_function(return_type_func, call_policies, func_sig());
// }
...
void define_buffer(py::module &m) {
    ...
    auto realization_class =
        py::class_<Realization>(m, "Realization")
        .def(py::init<Buffer<> &>())
