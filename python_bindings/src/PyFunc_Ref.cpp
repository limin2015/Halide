...
void define_func_tuple_element_ref(py::module &m) {
    auto func_tuple_element_ref_class =
        py::class_<FuncTupleElementRef>(m, "FuncTupleElementRef")
            // .def("__iadd__", &iadd_func<FuncTupleElementRef &, Expr>, py::args("expr"),
            ...
            // .def("__isub__", &isub_func<FuncTupleElementRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
            ...
            // .def("__imul__", &imul_func<FuncTupleElementRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
            ...
            //      "initial definition.")
            // .def("__idiv__", &idiv_func<FuncTupleElementRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
...
void define_func_ref_expr_class(py::module &m) {
    auto func_ref_expr_class =
        py::class_<FuncRef>(m, "FuncRef")
            // .def("__iadd__", &iadd_func<FuncRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
            ...
            // .def("__isub__", &isub_func<FuncRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
            ...
            // .def("__imul__", &imul_func<FuncRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
            ...
            // .def("__idiv__", &idiv_func<FuncRef &, Expr>, py::args("expr"),
            //      py::return_internal_reference<1>(),
    ...
    add_binary_operators(func_ref_expr_class);
...
void define_func_ref(py::module &m) {
    auto function_class = py::class_<Internal::Function>(m, "_InternalFunction");

    define_func_tuple_element_ref(m);
    define_func_ref_expr_class(m);
}
