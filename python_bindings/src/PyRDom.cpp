...
//                           .def(py::init<std::string>(py::args("name"), "Construct an RVar with the given name"))

//                           .def(py::init<Internal::ReductionDomain, int>(
//                               py::args("domain", "index"),
...
//                                       py::init<>("Construct an undefined reduction domain."))
//                           .def(py::init<Buffer<>>(py::args("buffer"),
...
//                           .def(py::init<OutputImageParam>(py::args("image_param"),
//                                                       "Construct a reduction domain that iterates over all points in "
//                                                       "a given Buffer, Image, or ImageParam. "
//                                                       "Has the same dimensionality as the argument."))
...
//                           .def("same_as", &RDom::same_as, py::args("other"),
...
//                           .def("where", &RDom::where, py::args("predicate"),
